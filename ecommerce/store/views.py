...
def login_user(request) :
    if request.method == 'POST' :
        ...
        if user is not None :
            ...
            return render(request , os.path.join(settings.BASE_DIR , "templates/store/invalid_action.html"))
    else :
        return render(request , os.path.join(settings.BASE_DIR , "templates/store/login.html") , {})
